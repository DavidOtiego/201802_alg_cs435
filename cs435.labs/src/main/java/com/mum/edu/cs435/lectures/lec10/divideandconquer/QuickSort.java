...
import com.mum.edu.cs435.lectures.lec03.sort_environment.runtime.*;
...
public class QuickSort extends Sorter {
	...
	public static void main(String[] args){
		...
		*/
		/*
		System.out.println((int)Math.pow(2,23));
		int x[]=new int[(int)Math.pow(2,23)];
		int y[]=new int[8388608];
		*/
	}
